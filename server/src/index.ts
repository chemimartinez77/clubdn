...
import surpriseBoxRoutes from './routes/surpriseBoxRoutes';
import multiplayerRoutes from './modules/boardgames/routes/multiplayerRoutes';
...
app.use('/api/surprise-boxes', surpriseBoxRoutes);
...
app.use('/api/event-photos', photoLibraryRoutes);
