...
const COMBAT_ZONE_GAMES = [
  ...
  { bggId: 'multiplayer', name: 'Multiplayer Lab', path: '/combatzone/multiplayer',    solo: false, launchMode: 'NAVIGATE',    fetchInfo: false },
...
GAME_FALLBACK_EMOJI.multiplayer = '\u2699\uFE0F'; // Multiplayer Lab
